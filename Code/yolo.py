...
class YOLO(object):
    _defaults = {
        "model_path": 'weights/lzsp-weight.pth',
        "anchors_path": 'model_data/yolo_anchors.txt',
        r"classes_path": 'model_data/lzsp_classes.txt',
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            anchors.append([predicted_class,(left, top, right, bottom)])
            # 画框框
            label = '{} {:.2f}'.format(predicted_class, score)
            try:
                summary[predicted_class] += 1
